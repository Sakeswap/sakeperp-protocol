...
contract ChainlinkL1 is OwnableUpgradeable, BlockContext {
    ...
    function isPriceUpdate(bytes32 _priceFeedKey) external view returns (bool) {
        ...
        if (timestamp > prevTimestampMap[_priceFeedKey]) {
            return true;
        }
        return false;
    }
